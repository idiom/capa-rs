...
use crate::{
    ...
    prelude::{
        ...
        MethodImplRaw, MethodModifiers, MethodSemanticsRaw, ModuleRaw, ModuleRefRaw,
        NestedClassRaw, ParamRaw, PermissionSet, PermissionSetFormat, PropertyMapRaw, PropertyRaw,
        StandAloneSigRaw, TableId, TypeDefRaw, TypeRefRaw, TypeSpecRaw, CIL_HEADER_MAGIC,
    },
    CilObject,
};
