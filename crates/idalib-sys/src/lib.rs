...
mod ffix {
    ...
    unsafe extern "C++" {
        ...
        unsafe fn idalib_enum_all_imports() -> String;
        ...
        // ua_extras: instruction text generation
        ...
        unsafe fn idalib_insn_segpref(ea: c_ulonglong) -> c_int;
    }
}
...
pub mod insn {
    ...
    pub use super::ffix::{
        idalib_generate_disasm_line, idalib_insn_segpref, idalib_print_insn_mnem,
        idalib_print_operand,
    };
...
pub mod nalt {
    ...
    pub use super::ffix::{
        idalib_enum_all_imports, idalib_get_import_module_name, idalib_get_import_module_qty,
